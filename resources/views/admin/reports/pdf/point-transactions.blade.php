...
<head>
    ...
    <style>
        * {
        ...
        Baik, saya akan update view PDF Sales Summary agar menampilkan informasi filter date range dengan lebih jelas:

resources/views/admin/reports/pdf/sales-summary.blade.php (Updated)
...
<body>
    ...
    <div class="header">
        ...
        <div class="subtitle">Complete Point Earnings and Redemptions History</div>
        ...
        <div class="filter-grid">
            <div class="filter-row">
                ...
                <div class="filter-item">
                    ...
                    <span class="filter-value">{{ ucfirst(request('type')) }}</span>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="summary-grid">
            <div class="summary-row">
                ...
                <div class="summary-item">
                    ...
                    <span class="value earned">+{{ number_format($summary['total_earned']) }}</span>
                </div>
                <div class="summary-item">
                    <span class="label">Total Redeemed</span>
                    <span class="value redeemed">-{{ number_format($summary['total_redeemed']) }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 12%;" class="text-right">Points</th>
                <th style="width: 12%;" class="text-right">Balance After</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="text-sm" style="color: #6b7280;">{{ $transaction->user->email ?? '-' }}</div>
                </td>
                <td>
                ...
                <td class="text-right font-bold {{ $transaction->type == 'earned' ? 'text-green' : 'text-red' }}">
                ...
                <td>
                    ...
                    <div class="text-sm" style="color: #6b7280;">{{ $transaction->created_at->format('H:i') }}</div>
                </td>
            </tr>
            @empty
            <tr>
