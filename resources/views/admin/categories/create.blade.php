    ...
    <div class="relative bg-gradient-to-r from-emerald-600 to-green-600 dark:from-emerald-800 dark:to-green-800 overflow-hidden shadow-lg rounded-xl">
        ...
        <div class="relative p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-xl font-bold mb-1">Create New Category</h1>
                    <p class="text-emerald-100 text-sm">Create a new Category for the Products</p>
                </div>
        ...
        <div class="p-5">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Enter the details of the category to be created</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('admin.categories.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Enter role name (e.g., T-Shirt, Jacket, Hoodie)">
