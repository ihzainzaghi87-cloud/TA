                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <form action="{{ route('admin.products.toggle-active', $product) }}" method="POST" class="inline">
                                ...
                                <button type="submit" class="focus:outline-none">
                                    ...
                                    @else
                                    <span class="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-200 cursor-pointer hover:bg-red-200">
                                        Inactive
                                    </span>
                                    @endif
                                </button>
