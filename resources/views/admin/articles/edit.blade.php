    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700">
        <div class="p-5">
            ...
            <form method="POST" action="{{ route('admin.articles.update', $article) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <!-- Thumbnail Upload -->
                <div>
                    <label for="thumbnail" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ $article->thumbnail ? 'Change' : 'Upload' }} Thumbnail <span class="text-gray-400 text-xs">(Optional)</span></label>
