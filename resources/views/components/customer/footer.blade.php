<footer class="bg-[#FAD470] pt-8">
    ...
    <div class="bg-white rounded-2xl md:rounded-3xl mx-4 md:mx-8 lg:mx-12 mb-8">
        ...
        <!-- Horizontal Section -->
        <div class="flex flex-col md:flex-row items-center justify-between gap-4 px-4 md:px-8 pb-6">
            <!-- Social Icons -->
            <div class="flex items-center space-x-3 order-2 md:order-1">
                <!-- Instagram -->
                <a href="#" class="bg-gray-200 hover:bg-yellow-400 rounded-full w-8 h-8 flex items-center justify-center transition-colors group">
                    <svg class="w-4 h-4 text-gray-700 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Address -->
            <div class="text-gray-700 text-xs text-center order-1 md:order-2">
            ...
            <div class="flex items-center space-x-2 order-3">
                <div class="px-2 py-1">
                    <span class="font-bold text-xl md:text-2xl">18+</span>
                </div>
                <span class="text-gray-600 text-xs">Score for adults</span>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start gap-6">
            ...
            <div class="w-full md:w-1/2 md:pl-2">
                <h3 class="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 leading-tight">
                    If you didn't find the products you are interested in or have questions?
                </h3>
            </div>

            <!-- Right Column: Description and Email Input -->
            <div class="w-full md:w-1/2 md:pl-8">
                ...
                <div class="flex w-full max-w-md">
                    <input
                        ...
                        class="flex-1 min-w-0 bg-white border border-gray-300 text-gray-700 px-3 md:px-4 py-2.5 md:py-3 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 text-sm md:text-base"
                    >
                    <button class="bg-gray-800 hover:bg-black text-white font-semibold px-4 md:px-6 py-2.5 md:py-3 rounded-r-lg transition duration-300 flex-shrink-0">
