    ...
    <section class="bg-white py-12 lg:py-16 font-sans overflow-hidden px-4 md:px-8">
        <div class="w-full">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
                        ...
                        <!-- Card 2: Instagram -->
                        <a href="https://www.instagram.com/the.paranoia" target="_blank" class="min-h-[320px] flex flex-col justify-center items-center bg-white p-10 rounded-[30px] shadow-[0_20px_50px_rgba(0,0,0,0.05)] text-center border border-gray-100 transform hover:-translate-y-2 transition duration-300 group">
                            <div class="mb-6">
